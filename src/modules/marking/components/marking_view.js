...
import { Solution, Practical, Group } from 'Cs/Entities';
...
export interface IComponent extends IContainerProps, IComponentProps, IComponentActions, IMutations { }

let user: Group<Solution>;
let index: number;
    ...
    <Grid columns={2}>
      ...
      <Column width={6}>
        <div style={{ height: '30px' }}>
          ...
          <Input defaultValue={selectedDate} classes={classes.dateInput} placeholder="dd/mm/yyyy" onChange={(e: any) => changeDate(e.currentTarget.value)} />
        </div>
...
interface IExercisesView {
  ...
  showMarked: boolean;
  showPending: boolean;
  markCalc: (solutions: Solution[]) => number;
}

let exercise: Group<Solution>;
