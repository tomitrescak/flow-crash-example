...
const mapMutationsToProps = (context: Context, { state, ownProps }: Apollo.IGraphQlProps<IContainerProps>): IComponentMutations => ({
...
const mapDispatchToProps = (context: Context, dispatch: Function, ownProps: IContainerProps): IComponentActions => {
  return {
    toggleMarked() {
